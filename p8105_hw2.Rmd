...
trash_wheel =
  readxl::read_excel("./TrashWheelCollectionData.xlsx", sheet = 2, range = "A3:M96", col_names = c("dumpster", "month", "year", "date", "weight_tons", "volume (cubic yards)", "plastic_bottles", "polystyrene", "cigarette_butts", "glass_bottles", "plastic_bags", "wrappers", "homes_powered")) %>% 
  janitor::clean_names() %>% 
  mutate(homes_powered = ((weight_tons*500)/1000)) %>% 
...
converting year from character value to numeric value:

...
The pols_month data set contains 822 observations of 9 variables
regarding number republican or democratic national politicians
...
```
    ...
    ## ℹ In argument: `age_at_onset = as.integer(age_at_onset)`.
    ## Caused by warning:
...
The average baseline age in this study was 69.814433. The proportion of
women in the study who are APOE4 carriers is 65.21%.
